...
impl TestOverrides for DynamicGasTest {
    ...
    fn modify_relayer_config(&self, config: &mut Config) {
        ...
        match &mut config.chains[0] {
            ChainConfig::CosmosSdk(chain_config_a) | ChainConfig::Namada(chain_config_a) | ChainConfig::Astria(chain_config_a) => {
        ...
        match &mut config.chains[1] {
            ChainConfig::CosmosSdk(chain_config_b) | ChainConfig::Namada(chain_config_b) | ChainConfig::Astria(chain_config_b) => {
