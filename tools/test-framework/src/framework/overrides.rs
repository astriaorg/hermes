...
use crate::{
    ...
    framework::{
        ...
        binary::{
            ...
            node::{NamadaParametersOverride, NodeConfigOverride, NodeGenesisOverride},
        },
        nary::channel::PortsOverride as NaryPortsOverride,
        supervisor::SupervisorOverride,
    },
    types::{config::TestConfig, topology::TopologyType},
};
...
pub trait TestOverrides {
    ...
    */
    ...
    fn namada_modify_parameter_file(&self, _parameter: &mut toml::Value) -> Result<(), Error> {
        Ok(())
    }
