...
fn build_transfer_message_astria(
    ...
    let timeout_height = match timeout_height {
        ...
        TimeoutHeight::At(height) => astria_core::generated::protocol::transaction::v1alpha1::IbcHeight {
            revision_number: height.revision_number(),
            revision_height: height.revision_height(),
        },
        TimeoutHeight::Never => astria_core::generated::protocol::transaction::v1alpha1::IbcHeight {
            revision_number: 0,
    ...
    let msg = astria_core::generated::protocol::transaction::v1alpha1::Ics20Withdrawal {
        ...
        fee_asset_id: default_native_asset_id().as_ref().into(),
    };
